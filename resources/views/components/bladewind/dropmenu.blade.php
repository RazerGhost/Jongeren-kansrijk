@props([ 'trigger' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<div class="relative inline-block text-left bw-dropmenu !z-40" tabindex="0">
    ...
    <div class="opacity-0 hidden bw-dropmenu-items bg-white dark:bg-dark-800 transition-all duration-300 transform origin-top-right -translate-y-2 scale-95 !z-50">
        <div class="absolute right-0 mt-1 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none dark:bg-dark-800 dark:border-dark-900 dark:divide-dark-700">
            {{$slot}}
        </div>
    </div>
</div>
